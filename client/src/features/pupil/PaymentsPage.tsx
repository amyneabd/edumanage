...
export function PupilPaymentsPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <p className="mt-1 text-sm text-ink-500">Your tuition payment status and history.</p>
      ...
      <Card className="mt-4 p-5">
        ...
        {!data || data.length === 0 ? (
          <div className="mt-3">
            <EmptyState title="No payment records yet" description="Your teacher hasn't recorded any payments yet." />
          </div>
        ) : (

...
export function PupilAttendancePage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <p className="mt-1 text-sm text-ink-500">{data?.className ?? "Votre classe"}</p>
      ...
      <Card className="mt-4 p-5">
        ...
        {isLoading ? (
          ...
          <p className="mt-6 text-center text-sm text-ink-700">Vous n'êtes pas encore affecté(e) à une classe.</p>
        ) : days.length === 0 ? (
